    ...
    <div className="nav-frame">
      <ReactGridLayout
        ...
        <div key="2" data-grid={layout[1]}>
          <Link className="nav" to="/work"><span class="dot2"></span>Work</Link>
        </div>
        <div key="3" data-grid={layout[2]}>
          <Link className="nav"to="/nektine"><span class="dot2"></span>Nektine</Link>
        </div>
        <div key="4" data-grid={layout[3]} style="background-color: black">
          <Link className="nav" to="/about"><span class="dot2"></span>Me</Link>
        </div>
      </ReactGridLayout>
    </div>
  );
